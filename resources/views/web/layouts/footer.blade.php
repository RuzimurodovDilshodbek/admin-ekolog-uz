<footer class="darkMode bg-white" style="margin-top: 30px;">
    <div class="footer container">
        <div class="footer__card row">
            <div class="col">
                <a href="#">
                    <img src="{{asset('images/footer-logo.svg')}}" class="lightIcon d-block img-fluid" alt="bolalar olami Logo"
                         loading="lazy" />
                    <img src="{{asset('images/logo_d.svg')}}" class="darkIcon d-none img-fluid" alt="bolalar olami Logo"
                         loading="lazy" />
                </a>
                ...
                <div class="d-flex" style="margin-top: 50px; gap: 22px;">
                    <a href="#"> <img src="{{asset('images/instagram-logo.svg')}}" alt="instagram-logo"></a>
                    <a href="#"><img src="{{asset('images/telegram-logo.svg')}}" alt="telegram-logo"> </a>
                    <a href="#"> <img src="{{asset('images/facebook-logo.svg')}}" alt="facebook-logo"></a>
                    <a href="#"> <img src="{{asset('images/youtube-logo.svg')}}" alt="youtube-logo"></a>
                </div>
            </div>
            <div class="col">
                <ul class="footer__list list-unstyled d-flex flex-column" style="gap: 24px;">
                    <li>
                        <a class="footer__link text-decoration-none fw-bold darkMode-title" href="#">Biz
                            haqimizda</a>
                    </li>
                    <li>
            ...
            <div class="col">
                <ul class="list-unstyled d-flex flex-column" style="gap: 24px;">
                    ...
                    <li class="d-flex" style="gap: 14px;">
                        ...
                        <img src="{{asset('images/tell-dark.svg')}}" alt="tell-dark icon" class="darkIcon d-none" />
                        <a class="footer__link1 fw-normal darkMode-title" href="#">998 (90) 109 24 35</a>
                    </li>
                    <li class="d-flex align-items-start" style="gap: 6px;">
                        <img src="{{asset('images/location-icon.svg')}}" alt="location-icon" class="lightIcon d-block " />
                        <img src="{{asset('images/gps-dark.svg')}}" alt="gps-dark icon" class="darkIcon d-none " />
            ...
            <div class="col">
                <ul class="list-unstyled d-flex flex-column" style="gap: 24px;">
                    ...
                    <li class="d-flex" style="gap: 13px;">
                        <img src="{{asset('images/telegram-icon.svg')}}" alt="telegram-icon" class="lightIcon d-block " />
                        <img src="{{asset('images/telegram-dark.svg')}}" alt="telegram-dark icon" class="darkIcon d-none " />
